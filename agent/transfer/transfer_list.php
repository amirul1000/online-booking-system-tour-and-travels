...
?>
<a href="index.php?cmd=edit" class="btn green">Add a transfer</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("transfer");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_transfer" >
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							 <td><?=$arr[$i]['source']?></td>
                              ...
                              <td><?=$arr[$i]['transfer_type']?></td>
                              <td><?=$arr[$i]['driving_time']?></td>
                              <td><?=$arr[$i]['one_way_cost']?></td>
                              <td><?=$arr[$i]['round_trip_cost']?></td>
                              <td><?=$arr[$i]['lat']?></td>
                              <td><?=$arr[$i]['lng']?></td>
