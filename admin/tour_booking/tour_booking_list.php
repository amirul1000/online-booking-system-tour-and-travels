...
?>
<a href="index.php?cmd=edit" class="btn green">Add a tour booking</a> <br><br>
           ...
           <div class="portlet-title">
            ...
            <div class="portlet-body">
	         <div class="table-responsive">	
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("tour_booking");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_tour_booking" >
			  ...
			  <td><?=$arr[$i]['excursion_date']?></td>
			  <td><?=$arr[$i]['no_of_adults']?></td>
			  <td><?=$arr[$i]['no_of_children']?></td>
