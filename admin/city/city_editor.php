...
<a href="index.php?cmd=list" class="btn green">List</a> <br><br>
  <div class="portlet box blue">
      <div class="portlet-title">
          <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","city"))?></b>
          </div>
          <div class="tools">
	                ...
	                <table class="table">
                                        <tr>
                                              <td>  
                                                 ...
                                                 <form name="frm_city" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
                                                  <div class="portlet-body">
                                                 <div class="table-responsive">	
                                                    <table class="table">
                                                         <tr>
                                                         ...
                                                         <tr>
                                                             <td>City Name</td>
                                                             <td>
                                                                <input type="text" name="city_name" id="city_name"  value="<?=$city_name?>" class="textbox">
                                                             </td>
                                                         </tr>
                                                         <tr>
                                                             <td>Status</td>
                                                             <td><?php
                                                                    $enumcity = getEnumFieldValues('city','status');
                                                                ?>
                                                                <select  name="status" id="status"   class="textbox">
                                                                <?php
                                                                   foreach($enumcity as $key=>$value)
                                                                   { 
                                                                ?>
