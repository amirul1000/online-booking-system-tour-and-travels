...
?>
<a href="index.php?cmd=edit" class="btn green">Add a transfer type</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("transfer_type");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_transfer_type" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['transfer_name']?></td>
			                  <td><img src="../../<?=$arr[$i]['file_picture']?>" style="width:50px;"></td>
			                  <td><?=$arr[$i]['status']?></td>
							  <td nowrap >
