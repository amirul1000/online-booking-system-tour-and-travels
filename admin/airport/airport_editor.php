...
?>
<script language="javascript" src="airport.js"></script>
...
<a href="index.php?cmd=list" class="btn green">List</a> <br><br>
  <div class="portlet box blue">
      <div class="portlet-title">
          <div class="caption"><i class="fa fa-globe"></i><b><?=ucwords(str_replace("_"," ","airport"))?></b>
          </div>
          <div class="tools">
	                ...
	                <table class="table">
                         <tr>
                          <td>  
                             ...
                             <form name="frm_airport" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
                              <div class="portlet-body">
                              <div class="table-responsive">	
                                <table class="table">
                                    <tr>
                                    ...
                                    <tr>
                                     <td>Airport Name</td>
                                     <td>
                                        <input type="text" name="airport_name" id="airport_name"  value="<?=$airport_name?>" class="textbox">
                                     </td>
                                     </tr>
                                     <tr>
                                         <td>Status</td>
                                         <td><?php
											$enumairport = getEnumFieldValues('airport','status');
										?>
										<select  name="status" id="status"   class="textbox">
										<?php
										   foreach($enumairport as $key=>$value)
										   { 
										?>
