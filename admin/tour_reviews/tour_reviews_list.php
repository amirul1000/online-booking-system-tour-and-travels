...
?>
<a href="index.php?cmd=edit" class="btn green">Add a tour_reviews</a> <br><br>
	         ...
	         <div class="table-responsive">	
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("tour_reviews");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_tour_reviews" >
			  ...
			  <td>Service Rating</td>
						 ...
						 <?php
								...
								$info["fields"] = array("tour_reviews.*"); 
							...
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = tour;	
										$info2['fields']   = array("description");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['tour_id']."' LIMIT 0,1";
										$res2  =  $db->select($info2);
										echo $res2[0]['description'];	
					                ?>
							   </td>
			  <td><?=$arr[$i]['name']?></td>
			  <td><?=$arr[$i]['email']?></td>
			  <td><?=$arr[$i]['feedback']?></td>
			  <td><?=$arr[$i]['service_rating']?></td>
