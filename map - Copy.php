   ...
   <!--Google Map-->
    ...
    //lat lng		
      var lat = '<?=$arrtransfer[0]['lat']?>';
      var lng = '<?=$arrtransfer[0]['lng']?>';
      var geocoder;
      var map;
      function initialize() {
      ...
      function codeAddress() {
        ...
        var address = "<?=$arrtransfer[0]['destination']?>";
      ...
      function placeMarker(location) {	
        ...
        function calculateAndDisplayRoute(directionsService, directionsDisplay) {
            directionsService.route({
              origin: "<?=$arrtransfer[0]['source']?>",
              destination: "<?=$arrtransfer[0]['destination']?>",
              travelMode: 'DRIVING'
