...
?>
<a href="index.php?cmd=edit" class="btn green">Add a excursion zone</a> <br><br>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("excursion_zone");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_excursion_zone" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['country']?></td> 
                              <td><?=$arr[$i]['zone_name']?></td>
                              <td><?=$arr[$i]['excursion_name']?></td>
                              <td><?=$arr[$i]['status']?></td>
							  <td nowrap >
