	...
	<form class="register-form" action="" method="post" style="display:block;">
		...
		<div class="form-group">
			...
			<select class="form-control placeholder-no-fix" type="text" placeholder="Member Type" name="user_type"/>
			    <option value="agent" <?php if($_REQUEST['user_type']=='agent'){ echo "selected";} ?>>Agent</option>
			    <option value="member" <?php if($_REQUEST['user_type']=='member'){ echo "selected";} ?>>Member</option>
			</select>
		</div>
		...
		<div class="form-actions">
		   <input type="hidden" name="cmd" value="register">
			<button type="button" id="register-back-btn" class="btn btn-default" onClick="location.href='login.php'">Back</button>
